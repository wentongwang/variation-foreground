        ...
        <div class="sub-content-1">
          ...
          <el-row :gutter="20">
            ...
            ><div class="grid-content">
              {{ $t('variat.Exonic_function') + variantion.exonicFunc }}
            </div></el-col>
            <el-col
              :span="10"
              :offset="0"
            ><div class="grid-content">
              {{ $t('variat.SIFT') + variantion.siftval }}
            </div></el-col>
          </el-row>
          <el-row :gutter="20">
            <el-col
              ...
              :offset="4"
            ><div class="grid-content">
              {{ $t('variat.ClinvarId') + variantion.clnalleleid }}
            </div></el-col>
            <el-col
              :span="10"
              :offset="0"
          ...
          <el-row :gutter="20">
            <el-col
              ...
              :offset="4"
            ><div class="grid-content">
              {{ $t('variat.CADD') + variantion.cadd_PHRED }}
            </div></el-col>
            <el-col
              :span="10"
              :offset="0"
            ><div class="grid-content">
              {{ $t('variat.GERP') + variantion.gerpS }}
            </div></el-col>
          </el-row>
        </div>
...
export default {
  ...
  methods: {
    handleChecked(value) {
      ...
      if (this.radio2 === 'chn100k') {
        this.freArr.push({
          population: window.vm.$t('variat.All'),
          frequency: this.variantion['chn100k_ALL']
        })
        this.freArr.push({
          population: window.vm.$t('variat.African'),
          frequency: this.variantion['chn100k_AFR']
        })
        this.freArr.push({
          population: window.vm.$t('variat.Amish'),
          frequency: this.variantion['chn100k_AMR']
        })
        this.freArr.push({
          population: window.vm.$t('variat.AshkenaziJewish'),
          frequency: this.variantion['chn100k_ASJ']
        })
        this.freArr.push({
          population: window.vm.$t('variat.EastAsian'),
          frequency: this.variantion['chn100k_EAS']
        })
        this.freArr.push({
          population: window.vm.$t('variat.EuropeanFinnish'),
          frequency: this.variantion['chn100k_FIN']
        })
        this.freArr.push({
          population: window.vm.$t('variat.EuropeanNonFinnish'),
          frequency: this.variantion['chn100k_NFE']
        })
        this.freArr.push({
          population: window.vm.$t('variat.Other'),
          frequency: this.variantion['chn100k_OTH']
        })
      }
      this.pieChart()
    },
